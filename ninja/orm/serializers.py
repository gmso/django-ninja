...
def is_one_relationship(data: Any) -> bool:
    return (
        isinstance(data, models.ForeignKey) or
        isinstance(data, models.OneToOneRel)
    )


def is_many_relationship(data: Any) -> bool:
    return (
        isinstance(data, models.ManyToManyRel) or
        isinstance(data, models.ManyToManyField) or 
        isinstance(data, models.ManyToOneRel)
    )
...
def serialize_queryset(data: models.query.QuerySet, referrers: Tuple[Any] = tuple()) -> Dict[Any, Any]:
    """Serializes Django Queryset to dictionary"""
    return [serialize_model_instance(obj, referrers) for obj in data]


def serialize_foreign_key(obj: models.Model, field: Any, referrers: Tuple[Any] = tuple()) -> Dict[Any, Any]:
...
def serialize_many_relationship(obj: models.Model, referrers: Tuple[Any] = tuple()) -> Dict[Any, Any]:
    """
